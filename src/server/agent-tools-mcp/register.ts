...
import { registerFocusObjectTools } from "../tools/focus-object-tools.js";
import { registerFocusGovernanceTools } from "../tools/focus-governance-tools.js";
...
export function registerAllBridgeTools(
  ...
  registerActionTools(server, ctx, { hiddenTools });
  registerFocusObjectTools(server, ctx, { hiddenTools });
  registerFocusGovernanceTools(server, ctx, { hiddenTools });
