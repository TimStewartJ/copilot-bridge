...
export interface StatusEvent {
  type: "session:busy" | "session:idle" | "session:title" | "session:intent" | "session:archived" | "server:restart-pending" | "server:restart-cleared" | "schedule:triggered" | "schedule:changed" | "task:changed";
  sessionId?: string;
  title?: string;
  intent?: string;
  archived?: boolean;
