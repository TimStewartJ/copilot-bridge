  ...
  defineBridgeTool("schedule_update", {
    ...
    parameters: {
      ...
      properties: {
        ...
        autoArchiveKeep: { anyOf: [{ type: "integer", minimum: 0 }, { type: "null" }], description: "Auto-archive older run sessions after keeping the latest N sessions active. Null disables auto-archive." },
      },
      required: ["scheduleId"],
    },
    handler: async (args: any) => {
